...
```bash
cd /Users/premaanshvyas/Developer/aussie-sky
...
```bash
cd /Users/premaanshvyas/Developer/aussie-sky/apps/web
...
```bash
cd /Users/premaanshvyas/Developer/aussie-sky/apps/orbital
...
- [ ] **Step 7: Manual verification on aussie-sky.vercel.app**
